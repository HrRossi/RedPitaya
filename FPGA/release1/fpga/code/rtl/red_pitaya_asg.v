...
/* legacy */reg buf_a_we;
/* legacy */reg [RSZ-1:0] buf_a_addr;
/* legacy */wire [14-1:0] buf_a_rdata;
/* legacy */wire [RSZ-1:0] buf_a_rpnt;
/* legacy */reg [32-1:0] buf_a_rpnt_rd;
...
/* legacy */reg buf_b_we;
/* legacy */reg [RSZ-1:0] buf_b_addr;
/* legacy */wire [14-1:0] buf_b_rdata;
/* legacy */wire [RSZ-1:0] buf_b_rpnt;
/* legacy */reg [32-1:0] buf_b_rpnt_rd;
...
/* legacy */.buf_we_i(buf_a_we),
/* legacy */.buf_addr_i(buf_a_addr),
/* legacy */.buf_wdata_i(wdata[14-1:0]),
/* legacy */.buf_rdata_o(buf_a_rdata),
/* legacy */.buf_rpnt_o(buf_a_rpnt),
...
/* legacy */.buf_we_i(buf_b_we),
/* legacy */.buf_addr_i(buf_b_addr),
/* legacy */.buf_wdata_i(wdata[14-1:0]),
/* legacy */.buf_rdata_o(buf_b_rdata),
/* legacy */.buf_rpnt_o(buf_b_rpnt),
...
/* legacy */  buf_a_we <= wen && (addr[19:RSZ+2] == 'h1);
/* legacy */  buf_b_we <= wen && (addr[19:RSZ+2] == 'h2);
/* legacy */  buf_a_addr <= addr[RSZ+1:2];
/* legacy */  buf_b_addr <= addr[RSZ+1:2];
/* legacy */end
...
/* legacy */if (ren) begin
/* legacy */  buf_a_rpnt_rd <= {{32-RSZ-2{1'b0}},buf_a_rpnt,2'h0};
/* legacy */  buf_b_rpnt_rd <= {{32-RSZ-2{1'b0}},buf_b_rpnt,2'h0};
/* legacy */end
/* legacy */ren_dly <= {ren_dly[3-2:0],ren};
/* legacy */ack_dly <= ren_dly[3-1] || wen;
   end
end
