 ...
 * Interrupt support (generated by DDR Dump) and reset IRQ pending signal, 
 * configuration registers for threshold interrupts.
 * 
 */
...
(
   ...
   output                sys_ack_o       ,  //!< bus acknowledge signal
    ...
    output      [   32-1:0] ddr_a_thrsh_o   ,   // DDR ChA interrupt threshold
    ...
    output      [   32-1:0] ddr_b_thrsh_o   ,   // DDR ChA interrupt threshold
    input       [    2-1:0] ddr_status_i    ,   // DDR [0,1]: threshold INT pending A/B
    output                  ddr_stat_rd_o   ,   // DDR INT pending was read
    output      [    6-1:0] ddr_control_o   ,   // DDR [0,1]: dump enable flag A/B, [2,3]: reload curr A/B, [4,5]: threshold INT enable A/B
...
reg  [  32-1:0] ddr_a_thrsh;    // DDR ChA interrupt threshold
...
assign ddr_a_thrsh_o = ddr_a_thrsh;
assign ddr_b_thrsh_o = ddr_b_thrsh;
